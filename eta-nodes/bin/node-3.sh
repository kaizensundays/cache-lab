...
export SERVER_PORT=7703
export JGROUPS_RAFT_MEMBERS=A,B,C
export JGROUPS_RAFT_NODE_NAME=C

export CMD="$JAVA_HOME/bin/java $FLAGS $JG_FLAGS $LOG -Dproperties=node.yaml -Dlogging.config=log4j2-3.xml -Dloader.main=com.kaizensundays.eta.jgroups.Main -cp service.jar org.springframework.boot.loader.launch.PropertiesLauncher"
