...
export SERVER_PORT=7702
export JGROUPS_RAFT_MEMBERS=A,B,C
export JGROUPS_RAFT_NODE_NAME=B

export CMD="$JAVA_HOME/bin/java $FLAGS $JG_FLAGS $LOG -Dproperties=node.yaml -Dlogging.config=log4j2-2.xml -Dloader.main=com.kaizensundays.eta.jgroups.Main -cp service.jar org.springframework.boot.loader.launch.PropertiesLauncher"
